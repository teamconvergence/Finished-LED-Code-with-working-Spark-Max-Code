...
public class OI {
	...
	Joystick driverBoard1 = new Joystick(RobotMap.p_driverBoard1);
	Joystick driverBoard2 = new Joystick(RobotMap.p_driverBoard2);
	...
	public boolean isPanel2(){
		return driverBoard1.getRawButton(RobotMap.p_panel2);
	}
	public boolean isPanel3(){
		return driverBoard2.getRawButton(RobotMap.p_panel3);
	}
